                           ...
                           <form onSubmit={formik.handleSubmit}>
                            <div className='row mb-3'>
                                ...
                                <div className='mb-3 col-md-6'>
                                    ...
                                    <select className="form-select" {...formik.getFieldProps('country_id')} onChange={(e)=>{
                                ...
                                <div className='mb-3 col-md-6'>
                                    ...
                                    <select className="form-select" {...formik.getFieldProps('state_id')} 
                                        onChange={(e) => {
                                ...
                                <div className='mb-3 col-md-6'>
                                    ...
                                    <select className="form-select" {...formik.getFieldProps('city_id')} >
