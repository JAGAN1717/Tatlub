export const MENUITEMS = [
   ...
   },
   {
      title: 'Shop', type: 'sub', children: [
         { path: '/shop/Doctors_list', title: 'Doctors', type: 'link' },
         { path: '/shop/Doctors_details', title: 'Doctor', type: 'link' },
         { path: '/shop/Booking', title: 'Booking', type: 'link' },
         { path: '/shop/Booking2', title: 'Booking2', type: 'link' },
         { path: '/shop/Business', title: 'Business', type: 'link' },
         { path: '/shop/addproduct', title: 'addproduct', type: 'link' },
         { path: '/shop/Listing', title: 'Listing', type: 'link' },
         // { path: '/shop/addlisting', title: 'addlisting', type: 'link' },
         ...
         { path: '/shop/addnewlisting', title: 'List View', type: 'link' }  
      ],
   },
   {
      title: 'Products', type: 'sub', children: [
         {
            title: 'Sidebar', type: 'sub', children: [
               { path: '/product-details/view', title: 'Left Sidebar', type: 'link' },
      ...
      title: 'Pages', type: 'sub', children: [
         ...
         },
         {
            title: 'Account', type: 'sub', children: [
               ...
               { path: '/page/account/Manage-orders', title: 'Wishlist', type: 'link' },
               { path: '/page/account/Enquiry-manage', title: 'Wishlist', type: 'link' },
               ...
               { path: '/page/account/branches', title: 'branches', type: 'link' },
               { path: '/page/account/Add-branch', title: 'Add-branch', type: 'link' },
               { path: '/page/account/checkout', title: 'checkout', type: 'link' },
               { path: '/page/account/Otpform', title: 'Wishlist', type: 'link' },
            ]
         },
