  ...
  return (
    <div>
      <a href={null} onClick={() => openSetting()}>
        <div className="setting-sidebar d-none" id="setting-icon">
          <div>
      ...
      <div className="sidebar-btn dark-light-btn d-none">
      ...
      <div className="addcart_btm_popup d-none" id="fixed_cart_icon">
